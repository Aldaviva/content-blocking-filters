...
buildFilterList -outputFilename ".\filters\bluesky-politics.txt" -title "Ben's Bluesky Politics Filter" -patternPrefix "bsky.app##div[data-testid^='feedItem-by-']:has(div[data-testid=postText], div[aria-label^='Post by '] > div[dir=auto]:has-text(" -patternSuffix "))"